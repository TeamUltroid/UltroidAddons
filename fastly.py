...
The bot will try to auto reply first to the messages by @FastlyWriteBot, @FastlyWriteCloneBot, @FastlyWriteClone2Bot and @FastlyWriteOfficialClone3Bot.
"""
...
async def fastOnOff(event):
    ...
    if not get_:
        ...
        ultroid_bot.add_handler(fastly_bot, events.NewMessage(incoming=True, from_users=[1806208310, 1983714367, 1877720720, 5053950120]))
