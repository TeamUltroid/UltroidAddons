# Credits @Theshashank (creator of plugin: shashank😎😎)   

   

# Ported from (not ported sur 🥺🥺 yakiin kro)   
...
async def _(event):
    ...
    caption = """<b>Extracted User info From Telegram By Ultroid userbot<b>
